    ...
    <AccordionPrimitive.Header className="flex">
      ...
      >
        ...
        <ChevronDown
          ...
          className="pointer-events-none shrink-0 size-4 text-muted-foreground group-aria-expanded/accordion-trigger:hidden"
        />
        <ChevronUp
          data-slot="accordion-trigger-icon"
          className="pointer-events-none hidden shrink-0 size-4 text-muted-foreground group-aria-expanded/accordion-trigger:inline"
        />
      </AccordionPrimitive.Trigger>
