...
import { FormInput, FormSelect, FormTextarea, FormSwitch, useZodForm } from '@shipflow/ui-forms';
...
export default function OnboardingPage() {
  ...
  React.useEffect(() => {
    ...
    api
      .get<CompanyFormValues & { logoUrl?: string }>(`/organizations/${activeOrg.id}`)
      .then((org) => {
        reset({
          name: org.name ?? '',
          ...
          masterCurrency:
            ((org as Record<string, unknown>).masterCurrency as 'USD' | 'INR') ?? 'USD',
  ...
  async function uploadFile(orgId: string, file: File, type: 'logo' | 'signature') {
    ...
    await fetch(`${API_BASE_URL}/organizations/${orgId}/${type}`, {
      method: 'POST',
      ...
      <div className="flex-1 bg-gray-50 px-4 py-8">
        <div className="mx-auto w-full max-w-5xl space-y-6">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList
              variant="line"
              className="w-full justify-start gap-6 border-b bg-transparent px-1 pb-0"
            >
              {[
                ...
                <div className="rounded-xl border bg-white p-6 shadow-sm space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-xs text-muted-foreground -mt-2">
                      For LLPs use LLP Reg No format (e.g. AAB-1234). For Pvt Ltd use CIN format
                      (e.g. U12345MH2020PTC123456).
                    </p>
                    <FormTextarea
                      control={control}
                      name="addressLine1"
                  ...
                  <div className="space-y-4">
                    <SectionHeader
                      ...
                      description="Set your default pricing currency for items and documents."
                    />
                    <Separator />
                    ...
                    <p className="text-xs text-muted-foreground">
                      Note: Changing the master currency only affects new items. Existing items
