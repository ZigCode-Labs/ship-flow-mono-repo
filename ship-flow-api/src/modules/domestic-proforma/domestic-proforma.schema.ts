...
export const createDomesticProformaSchema = z.object({
  ...
  lineItems: z
    .array(domesticProformaItemSchema)
    .min(1, 'At least one line item is required'),
});

export const updateDomesticProformaSchema =
  createDomesticProformaSchema.partial();

export type CreateDomesticProformaDto = z.infer<
  typeof createDomesticProformaSchema
>;
export type UpdateDomesticProformaDto = z.infer<
  typeof updateDomesticProformaSchema
>;
